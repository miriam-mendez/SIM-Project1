...
#The intercept is difficult to intercept because it is impossible to have 0's for all values
...
boxcox( charges ~ age + bmi + children , data=df)

boxCoxVariable( log(charges) ~ age + bmi + I(children+0.5) , data=df)

boxTidwell( log(charges) ~ age + bmi + I(children+0.5) , data=df)
